...
#     'simulador.middleware_messages.DeDuplicateMessagesMiddleware',
...
STATIC_URL = '/static/'  # Modificado para incluir a barra inicial
...
CSRF_TRUSTED_ORIGINS = ['https://simulador.spsystems.pro']
